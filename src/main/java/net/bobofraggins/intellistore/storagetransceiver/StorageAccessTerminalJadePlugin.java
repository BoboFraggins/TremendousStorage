 ...
 */
@WailaPlugin
public class StorageAccessTerminalJadePlugin implements IWailaPlugin {
    ...
    public void register(IWailaCommonRegistration registration) {
        registration.registerBlockDataProvider(SatDataProvider.INSTANCE, StorageAccessTerminalBlock.class);
    }

    @Override
    public void registerClient(IWailaClientRegistration registration) {
        registration.registerBlockComponent(SatDataProvider.INSTANCE, StorageAccessTerminalBlock.class);
    }
    ...
    enum SatDataProvider implements IBlockComponentProvider, snownee.jade.api.IServerDataProvider<BlockAccessor> {
        ...
        public void appendServerData(CompoundTag data, BlockAccessor accessor) {
            ...
            net.minecraft.core.BlockPos niPos =
                    StorageAccessTerminalBFS.findNI(serverLevel, accessor.getPosition());
            if (niPos == null) {
