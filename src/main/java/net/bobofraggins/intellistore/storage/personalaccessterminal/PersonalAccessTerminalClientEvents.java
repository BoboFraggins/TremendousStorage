...
import net.bobofraggins.intellistore.storage.wirelesshub.WirelessHubRenderer;
import net.bobofraggins.intellistore.storage.wirelesshub.WirelessHubScreen;
...
public final class PersonalAccessTerminalClientEvents {
    ...
    public static void onRegisterKeyMappings(RegisterKeyMappingsEvent event) {
        OPEN_WIRELESS_SAT = new KeyMapping(
                "key.intellistore.open_personal_access_terminal",
