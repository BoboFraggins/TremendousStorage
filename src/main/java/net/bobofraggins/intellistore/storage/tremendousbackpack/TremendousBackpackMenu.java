 ...
 * Grid extraction is handled by {@link net.bobofraggins.intellistore.shared.network.TremendousBackpackInteractPacket}.
 *
...
public class TremendousBackpackMenu extends AbstractContainerMenu {
    ...
    public TremendousBackpackMenu(
        ...
        this(syncId, playerInv, slotType, slotIndex, slotId, data, IntelliStoreClientConfig.ROWS_SCALE_4_PLUS_DEFAULT);
    }
    ...
    /** Called from {@link net.bobofraggins.intellistore.shared.network.SetTremendousBackpackPriorityPacket} to push new priority to client. */
