 ...
 * {@link net.bobofraggins.intellistore.storage.tremendouschest.TremendousChestRenderer}.
 *
...
public class TremendousBackpackRenderer
    ...
    static final ModelResourceLocation BODY_MODEL = ModelResourceLocation.standalone(
            ResourceLocation.fromNamespaceAndPath("intellistore", "block/tremendous_backpack_body"));
    static final ModelResourceLocation FLAP_MODEL = ModelResourceLocation.standalone(
            ResourceLocation.fromNamespaceAndPath("intellistore", "block/tremendous_backpack_flap"));
    ...
    public TremendousBackpackRenderer(BlockEntityRendererProvider.Context ctx) {}
    ...
    public void render(
        ...
        Direction facing = blockState.getValue(TremendousBackpackBlock.FACING);
