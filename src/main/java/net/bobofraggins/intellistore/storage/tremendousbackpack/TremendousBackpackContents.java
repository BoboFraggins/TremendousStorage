 ...
 * {@link #withExtracted}.
 */
public final class TremendousBackpackContents {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, TremendousBackpackContents> STREAM_CODEC =
            new StreamCodec<>() {
                ...
                @Override
                public TremendousBackpackContents decode(RegistryFriendlyByteBuf buf) {
                ...
                @Override
                public void encode(RegistryFriendlyByteBuf buf, TremendousBackpackContents value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof TremendousBackpackContents other)) return false;
