...
public final class AccessTerminalLayout {
    ...
    public static final int CRAFTING_RESULT_X = 110;
    ...
    // Horizontally centred between grid right edge (84) and result slot left (110)
    public static final int ARROW_X =
            (CRAFTING_GRID_X + CRAFTING_ROWS * SLOT_SIZE + CRAFTING_RESULT_X - ARROW_W) / 2; // ~85

    // ── Player inventory ──────────────────────────────────────────────────────

    public static final int PLAYER_INV_X = 8;
    public static final int PLAYER_INV_Y = CRAFTING_Y + CRAFTING_H + GAP * 2; // 152
