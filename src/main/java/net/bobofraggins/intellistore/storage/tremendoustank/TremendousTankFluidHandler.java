...
/**
 * Exposes the Tremendous Tank as a single-tank {@link IFluidHandler} for pumps and fluid automation.
 *
 * <p>Insert rules:
 * <ol>
 ...
 * </ol>
 */
public class TremendousTankFluidHandler implements IFluidHandler {

    private final TremendousTankBlockEntity be;

    public TremendousTankFluidHandler(TremendousTankBlockEntity be) {
        this.be = be;
    }
