...
/**
 * Renders the Tremendous Tank's dynamic content: fluid fill level and tube-connector stubs.
 *
 * <p>The static shell is rendered by the block model ({@code models/block/tremendous_tank.json}).
