 ...
 * (clicking a {@link FluidTankBlock} with this item) are already handled by
 * {@link FluidTankBlock#useItemOn}, which intercepts first via the block's capability.
 *
 * <p>Shows a tooltip with the stored fluid name and fill level when the tank holds fluid.
 */
public class FluidTankItem extends TieredBlockItem {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> lines, TooltipFlag flag) {
        ...
        if (contents.isLocked()) {
            ...
            lines.add(Component.translatable(
                            "item.intellistore.fluid_tank.tooltip",
     ...
     * this tank item via its registered {@link FluidTankItemFluidHandler} capability.
     */
    @Override
