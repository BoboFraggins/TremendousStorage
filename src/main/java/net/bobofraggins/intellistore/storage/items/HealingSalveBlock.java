...
/**
 * The world-placed fluid block for Healing Salve.
 *
 ...
 */
public class HealingSalveBlock extends LiquidBlock {

    public HealingSalveBlock(FlowingFluid fluid, Properties props) {
        super(fluid, props);
    }
}
