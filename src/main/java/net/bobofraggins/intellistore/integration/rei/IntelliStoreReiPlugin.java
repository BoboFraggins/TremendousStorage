package net.bobofraggins.intellistore.integration.rei;
...
/**
 * REI plugin entry point for IntelliStore.
 *
 * <p>This class is loaded exclusively by REI's own class scanner via {@link REIPluginClient}.
 * It is never referenced from IntelliStore's own startup code, so it causes no
 * {@link ClassNotFoundException} when REI is absent.
 */
@REIPluginClient
public class IntelliStoreReiPlugin implements REIClientPlugin {
