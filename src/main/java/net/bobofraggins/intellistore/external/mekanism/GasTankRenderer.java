 ...
 * ({@code models/block/gas_tank.json}) via {@link net.minecraft.world.level.block.RenderShape#MODEL}.
 * This BESR is responsible only for the parts that change at runtime:
 * <ul>
 *   <li>Chemical fill box (translucent, height proportional to fill fraction)
...
public class GasTankRenderer implements BlockEntityRenderer<GasTankBlockEntity> {
    ...
    // Chemical interior bounds (inside the glass jar)
