...
public record FolderContents(Optional<ItemStack> storedItem, long count) {
    ...
    /** Returns the type reference; set by {@link net.bobofraggins.intellistore.register.Registration}. */
    public static DataComponentType<FolderContents> type() {
        return net.bobofraggins.intellistore.register.Registration.FOLDER_CONTENTS.get();
    }
}
