...
/**
 * Fan processing type that activates when the airflow passes through Positive Vibes fluid.
 *
 * <p>Transforms Zombie Brains into Brains. Tints the fan's airflow particles teal-blue,
 * sampled from the {@code positive_vibes_flow.png} texture (avg colour #048ECF).
 * Living entities caught in the flow receive a brief Regeneration I effect.
 */
public class PositiveVibesFanProcessingType implements FanProcessingType {
