package net.bobofraggins.tremendousstorage.external.mysticalagriculture;
 ...
 * no manual wiring in {@link net.bobofraggins.tremendousstorage.shared.register.Registration} is needed.
 * MA auto-registers the crop block, {@code tremendousstorage:lazurite_essence}, and
 * {@code tremendousstorage:lazurite_seeds} items, which resolve to our model/texture files.
 */
