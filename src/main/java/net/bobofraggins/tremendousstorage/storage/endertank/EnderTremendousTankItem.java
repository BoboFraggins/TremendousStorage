...
/**
 * Block item for the Ender Tremendous Tank. Extends {@link TremendousTankItem} to inherit
 * fluid tooltip and bucket interaction, and appends "(Ender)" or "(Tier/Ender)" to the name.
 */
public class EnderTremendousTankItem extends TremendousTankItem {

    public EnderTremendousTankItem(Block block, Properties properties) {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> lines, TooltipFlag flag) {
        ...
        if (linkId != -1L) {
            lines.add(Component.translatable(
                    "item.tremendousstorage.ender_tremendous_tank.linked",
