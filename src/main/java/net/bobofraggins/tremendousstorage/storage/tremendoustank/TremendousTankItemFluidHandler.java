...
/**
 * {@link IFluidHandlerItem} capability for the Tremendous Tank block item.
 *
 * <p>Reads and writes fluid state via the {@link TremendousTankContents} data component.
 ...
 * automatically.
 */
public class TremendousTankItemFluidHandler implements IFluidHandlerItem {

    private final ItemStack container;

    public TremendousTankItemFluidHandler(ItemStack stack) {
    ...
    private TremendousTankContents contents() {
        TremendousTankContents c = container.get(Registration.TREMENDOUS_TANK_CONTENTS.get());
        return c != null ? c : TremendousTankContents.EMPTY;
    }
    ...
    public FluidStack getFluidInTank(int tank) {
        TremendousTankContents c = contents();
    ...
    public int fill(FluidStack resource, FluidAction action) {
        ...
        if (action.execute()) {
            ...
            container.set(
                    Registration.TREMENDOUS_TANK_CONTENTS.get(),
                    new TremendousTankContents(newType, c.amount() + toFill));
        }
        return toFill;
    }
    ...
    public FluidStack drain(int maxDrain, FluidAction action) {
        ...
        if (action.execute()) {
            container.set(
                    Registration.TREMENDOUS_TANK_CONTENTS.get(),
                    new TremendousTankContents(c.storedFluid(), c.amount() - toDrain));
        }
        return result;
    }
}
