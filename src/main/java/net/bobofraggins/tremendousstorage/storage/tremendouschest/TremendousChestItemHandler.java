 ...
 * </ol>
 */
public class TremendousChestItemHandler implements IItemHandler, IKeyCounterContributor, IPreferredStorage {

    private final TremendousChestBlockEntity be;

    public TremendousChestItemHandler(TremendousChestBlockEntity be) {
        this.be = be;
    }
    ...
    public boolean isItemValid(int slot, ItemStack stack) {
        return TremendousChestBlockEntity.accepts(stack);
    }
    ...
    public ItemStack insertItem(int slot, ItemStack stack, boolean simulate) {
        if (!TremendousChestBlockEntity.accepts(stack)) return stack;
