...
public class BackpackWornLayer extends RenderLayer<AbstractClientPlayer, PlayerModel<AbstractClientPlayer>> {
    ...
    public void render(
        ...
        BakedModel bodyModel = mc.getModelManager().getModel(BackpackRenderer.BODY_MODEL);
        BakedModel flapModel = mc.getModelManager().getModel(BackpackRenderer.FLAP_MODEL);
