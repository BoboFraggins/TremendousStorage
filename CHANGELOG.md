...
* Add missing Jade upgrade names
* Fix removing items from externally attached storages
* Fix energy handling in network
* Remove all debug logging
* Lower cost of Emerald to Netherite Upgrade
